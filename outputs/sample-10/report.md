...
**Appeal — original denial reason:** Denial date: 05 / 20 / 2026. Published fees could not be verified on the provider’s website.

**Applicant's justification:** Attached is a rate sheet obtained from the gym confirming the $30 group-class rate. The class is open to the public and subject-based (martial arts), consistent with OPWDD community-class guidelines. We respectfully request reconsideration of the denial.
...
Automated rule-based check of Gracie Barra's website found 4 of 9 website-verifiable items, with 5 needing manual review. No AI model was used for this review — a human should double-check any 'Needs Review' items before deciding.
...
| ✅ Found | Class is subject-based (art, dance, martial arts, cooking, etc.) | The page describes a subject-based activity ('art'). | [https://graciebarra.com/#modal-bookclass](https://graciebarra.com/#modal-bookclass)<br>`evidence/evidence-subject-based-evidence-class-is-subject-based-art-danc.png` |
...
| ✅ Found | A published schedule exists | The page shows scheduling information ('calendar'). | [https://graciebarra.com/#modal-bookclass](https://graciebarra.com/#modal-bookclass)<br>`evidence/evidence-published-schedule-evidence-a-published-schedule-exists.png` |
...
| ⚠️ Needs Review | Website evidence that specifically supports or refutes the stated denial reason | The denial reason concerns fees, but no price could be read from the site — this neither supports nor refutes the denial automatically; please review. | — |
...
- https://graciebarra.com/
- https://graciebarra.com/#modal-bookclass

## Evidence captures

All captures are date-stamped with the capture time (UTC) and URL burned into the image.

- `evidence/evidence-published-schedule-evidence-a-published-schedule-exists.png`
- `evidence/evidence-subject-based-evidence-class-is-subject-based-art-danc.png`